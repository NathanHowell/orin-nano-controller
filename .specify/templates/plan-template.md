...
- Confirm the impacted connector/pin data in `pcb/orin-nano-controller/BASELINE.md` is current and referenced in this plan (Principle I).
- Provide a deterministic boot/reset state machine or Embassy task breakdown with timing budgets for the change (Principle II).
